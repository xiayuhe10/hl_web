<template>
  <el-dialog title="添加审核人员" :visible.sync="visible" width="800px" top="5vh" append-to-body>
  ...
  export default {
    ...
    methods: {
      ...
      handleSelectUser() {
        ...
        this.$emit('ok', this.checkUserList)
        this.visible = false
        // addUserBlacklistBatch({ userIds: userIds }).then(res => {
