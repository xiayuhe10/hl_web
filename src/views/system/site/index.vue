<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="siteList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="所属项目" align="center" prop="plantName"/>
      <el-table-column label="所属公司" align="center" prop="companyName"/>
      <el-table-column label="施工名称" align="center" prop="name"/>
      ...
      <el-table-column label="联系方式" align="center" prop="principalPhone"/>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="所属项目" prop="type">
              <el-select v-model="form.plantId" placeholder="请选择项目名称" style="width: 100%">
                <el-option v-for="item in  mixingPlantList" :key="item.id" :label="item.name"
                           :value="item.id">
                </el-option>
              </el-select>
            </el-form-item>
          ...
          <el-col :span="12">
            <el-form-item label="状态" prop="type">
              <el-select v-model="form.status" clearable placeholder="选择状态" style="width: 100%">
          ...
          <el-col :span="24">
            <el-form-item label="工地地址" prop="address">
              <el-row>
                <el-col :span="20">
                  <el-input v-model="form.address" placeholder="请输入工地地址" style="width: 100%;" id="siteinput"></el-input>
                </el-col>
                <div class="drawStation" style="margin-top: 50px">
                  <div id="draw-site-container">
                    <div class="input">
  ...
  export default {
    ...
    methods: {
      ...
      getPlantList() {
        ...
        listMixingPlant(param).then(response => {
      ...
      /** 详情按钮操作 */
      handleDetail(row) {
        this.$router.push('/mixingPlant/siteAdd/' + row.id)
      },
      /** 提交按钮 */
      submitForm() {
      ...
      handleDelete(row) {
        ...
        this.$modal.confirm('是否确认删除施工工地编号为"' + ids + '"的数据项？').then(function() {
          return delSite(ids)
        }).then(() => {
          this.getList()
      ...
      initMap() {
        ...
        AMapLoader.load({
          ...
          .then((AMap) => {
            this.map = new AMap.Map('draw-site-container', {
              // 设置地图容器id
...
<style>
  .drawStation #draw-site-container {
    padding: 0px;
    width: 100%;
    height: 400px;
  }
